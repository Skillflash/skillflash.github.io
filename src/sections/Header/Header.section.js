            ...
            <div className={`${styles.mainWrapperDotted}`}>
                <div className={`${styles.headerContent}`}>
                    ...
                    <button className={`${styles.headerButton} ${scrollY >= 390 && styles.headerButtonFixed}`}>
                        <h6 className={`${styles.headerButtonText} ${scrollY >= 390 ? `from-secondary-pink via-secondary-pink to-primary-orange` : 'from-neutral-white to-neutral-white'}`}>Suche konfigurieren</h6>
